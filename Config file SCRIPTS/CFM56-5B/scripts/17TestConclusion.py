...
#*  17TestConclustion.tps
#******************************************************************************
#*  AUTHOR: John Tamplin
#*
#*  DESCRIPTION:REFERANCE:CFM56-5B ENGINE MANUAL 72-00-00
#*  Test Conclusion
#*
#*  DATE: 1/10/2013 10:32:24 AM
#*
#*  MODIFICATIONS:
...
if RotorRot:
	result("Rotor rotation found satisfactory. {} RotorRotation ".format(REPORT))

else:
	result("Rotor rotation were not satisfactory {} RotorRotation ".format(REPORT))
