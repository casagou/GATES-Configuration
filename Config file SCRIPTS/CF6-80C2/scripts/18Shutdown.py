...
channel("Eng_On,GIFlag,tAtGI,NAStop,NBStop,T495SELAOB,TransReset,FuelCondLvr,NARDWN,NBRDWN,N1RDWN,N2RDWN,FCS_AirRdy,SAV_ON,StrtVlvEnST")
...
wait("FuelCondLvr=0",10,0.1,WAIT_PARAM3_DFT,WAIT_PARAM4_DFT,WAIT_PARAM5_DFT,WAIT_PARAM6_DFT,WAIT_PARAM7_DFT, MSG,"Fuel switch not off")
...
if Moto:
	...
	wait("T495SELAOB < 100",120,0,WAIT_PARAM3_DFT,WAIT_PARAM4_DFT,WAIT_PARAM5_DFT,WAIT_PARAM6_DFT,WAIT_PARAM7_DFT,MSG,"Engine Start Valve can be turned OFF")
