...
result("Working Cell reads= {} lbs".format(str(getCV("FNnet")) ), REPORT + "IdleLeakCheck")
...
wait("TLAFILTR = 35", 30, 1.0, WAIT_PARAM3_DFT, WAIT_PARAM4_DFT, WAIT_PARAM5_DFT, WAIT_PARAM6_DFT, WAIT_PARAM7_DFT, MSG, "TRA is not reading 35 degrees.")
...
wait("TLAFILTR = 88", 30, 0.5, WAIT_PARAM3_DFT, WAIT_PARAM4_DFT, WAIT_PARAM5_DFT, WAIT_PARAM6_DFT, WAIT_PARAM7_DFT, MSG, "TRA is not reading 88 degrees.")
...
wait("TLAFILTR = 35", 30, 1.0, WAIT_PARAM3_DFT, WAIT_PARAM4_DFT, WAIT_PARAM5_DFT, WAIT_PARAM6_DFT, WAIT_PARAM7_DFT, MSG, "TRA is not reading 30 degree after 30 s")
