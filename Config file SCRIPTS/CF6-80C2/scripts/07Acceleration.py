...
channel("Eng_On,GIFlag,tAcc2,tAtGI,TransReset,VibReset,AccelOn,TransReset,N1_OBS,N1TO,N1ACC15,N1ACC,Accel")
...
if getFV("tAcc2") > 10:
	result("Acceleration time: {} seconds.".format(str(round(getFV("tAcc2"),4)) ),REPORT + "AccelCheck",RED)
	...
	result("Acceleration time: {} seconds.".format(str(round(getFV("tAcc2"),4)) ),REPORT + "AccelCheck")
