...
channel("Eng_On, N1_OBS, N2_OBS, N2GIL, N2GIH, TT2,VSVSEL,VBVSEL,T495SELAOB,OILQTY, FANBRGN1, FANBRGN2, FANBRGN1_ALT, FANBRGN2_ALT, VIBCRFN1, VIBCRFN2, POIL, POILC,POILCLOLO, POILCHIHI,FNnet, WF")
...
result("Thrust = {} lbs".format(str(getFV("FNnet")) ), REPORT + "IdleLeakCheck")
